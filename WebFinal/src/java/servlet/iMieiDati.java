    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           out.println("<!DOCTYPE html>");
            ...
            out.println("                   <image src=\"Images/singleicon.png\" style=\"height:150px; width: 150px;\" >");
            out.println("              </div>");
            out.println("              <div style=\"font-size: 40px; margin-top: 40px; position:relative;\" >");
            out.println("                    <label class=\"stdlabel\">Modifica Nome:</label><input name=\"nomeModificato\" placeholder="+ utente.getUsername()+" type=\"text\" class=\"stdinput\">");
            out.println("              </div>");
            out.println("              <div>");
            out.println("                  <label class=\"stdlabel\">Vecchia password:</label><input name=\"vecchiaPassword\" type=\"password\" class=\"stdinput\"></br>");
            out.println("                  <label class=\"stdlabel\">Nuova password:</label><input name=\"nuovaPassword\" type=\"password\" class=\"stdinput\">");
            out.println("              </div>");
